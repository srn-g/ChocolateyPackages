...
$url = 'https://github.com/csanuragjain/APKRepatcher/releases/download/v1.1.0/APKRepatcher.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName   = 'apkrepatcher*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
