...
$url = 'https://www.netresec.com/?download=NetworkMiner' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName   = 'network-miner*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
